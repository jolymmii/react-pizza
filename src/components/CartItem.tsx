...
const typeName = ['тонкое', 'традиционное'] as const // Массив типов пиццы
const CartItem: React.FC<CartProps> = ({
	...
	const sizes = [size] // если size — это одно значение
	const typeIndex = typeof type === 'string' ? typeName.indexOf(type) : type
